...
public class QuestionBankController {
    ...
    public BaseResponse<Long> addQuestionBank(@Valid @RequestBody QuestionBankAddRequest questionBankAddRequest,
    ...
    public BaseResponse<Boolean> updateQuestionBank(
            @Valid @RequestBody QuestionBankUpdateRequest questionBankUpdateRequest, HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> reviewQuestionBank(@Valid @RequestBody QuestionBankEditRequest questionBankEditRequest,
            HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> deleteQuestionBank(@Valid @RequestBody DeleteRequest deleteRequest,
            HttpServletRequest request) {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(
            @RequestParam @Min(value = 1, message = "ID必须大于0") long id) {
    ...
    public BaseResponse<List<QuestionVO>> getQuestionsByQuestionBankId(
        ...
        // ThrowUtils.throwIf(questionBank.getReviewStatus() != 1,
        // ErrorCode.FORBIDDEN_ERROR, "题库未通过审核");

        // 查询题库题目关联
        com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<QuestionBankQuestion> queryWrapper = new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<>();
