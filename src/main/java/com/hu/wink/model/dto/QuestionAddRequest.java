...
public class QuestionAddRequest implements Serializable {
     ...
     * 标题
     */
    @Schema(description = "题目标题", example = "Java基础题目", requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     * 内容
     */
    @Schema(description = "题目内容", example = "以下哪个是Java的基本数据类型？", requiredMode = Schema.RequiredMode.REQUIRED)
